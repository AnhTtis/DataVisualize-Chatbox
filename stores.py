...
class FirebaseStore:
    ...
    def save_media(
        ...
        try:
            ...
            # Mongo/GridFS save failed: do not write any local cache; let callers decide fallbacks.
            self.last_error = traceback.format_exc()
            if KB_ENABLE_TIMING_LOGS:
                print(self.last_error)
            return None
    ...
    def load_media_bytes(
        ...
        try:
            if backend == "mongodb":
                ...
                # Connect and read from GridFS. If Mongo is reachable and id is valid, downloads must succeed.
